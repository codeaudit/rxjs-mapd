...
// Edited 05/23/2017 to remove Q
// TODO(ptaylor): Thrift PRs:
// 1. codegen ES6/TS and/or TS-style enums
// 2. codegen base classes to reduce file sizes
//

var Thrift = require('thrift').Thrift;
var ttypes = module.exports = {};

ttypes.TDatumType = (function (TDatumType) {
    TDatumType[TDatumType["SMALLINT"] = 0] = "SMALLINT";
    TDatumType[TDatumType["INT"] = 1] = "INT";
    TDatumType[TDatumType["BIGINT"] = 2] = "BIGINT";
    TDatumType[TDatumType["FLOAT"] = 3] = "FLOAT";
    TDatumType[TDatumType["DECIMAL"] = 4] = "DECIMAL";
    TDatumType[TDatumType["DOUBLE"] = 5] = "DOUBLE";
    TDatumType[TDatumType["STR"] = 6] = "STR";
    TDatumType[TDatumType["TIME"] = 7] = "TIME";
    TDatumType[TDatumType["TIMESTAMP"] = 8] = "TIMESTAMP";
    TDatumType[TDatumType["DATE"] = 9] = "DATE";
    TDatumType[TDatumType["BOOL"] = 10] = "BOOL";
    TDatumType[TDatumType["INTERVAL_DAY_TIME"] = 11] = "INTERVAL_DAY_TIME";
    TDatumType[TDatumType["INTERVAL_YEAR_MONTH"] = 12] = "INTERVAL_YEAR_MONTH";
    return TDatumType;
})({});

ttypes.TEncodingType = (function (TEncodingType) {
    TEncodingType[TEncodingType["NONE"] = 0] = "NONE";
    TEncodingType[TEncodingType["FIXED"] = 1] = "FIXED";
    TEncodingType[TEncodingType["RL"] = 2] = "RL";
    TEncodingType[TEncodingType["DIFF"] = 3] = "DIFF";
    TEncodingType[TEncodingType["DICT"] = 4] = "DICT";
    TEncodingType[TEncodingType["SPARSE"] = 5] = "SPARSE";
    return TEncodingType;
})({});

ttypes.TExecuteMode = (function (TExecuteMode) {
    TExecuteMode[TExecuteMode["HYBRID"] = 0] = "HYBRID";
    TExecuteMode[TExecuteMode["GPU"] = 1] = "GPU";
    TExecuteMode[TExecuteMode["CPU"] = 2] = "CPU";
    return TExecuteMode;
})({});

ttypes.TTableType = (function (TTableType) {
    TTableType[TTableType["DELIMITED"] = 0] = "DELIMITED";
    TTableType[TTableType["POLYGON"] = 1] = "POLYGON";
    return TTableType;
})({});

ttypes.TMergeType = (function (TMergeType) {
    TMergeType[TMergeType["UNION"] = 0] = "UNION";
    TMergeType[TMergeType["REDUCE"] = 1] = "REDUCE";
    return TMergeType;
})({});

ttypes.TExpressionRangeType = (function (TExpressionRangeType) {
    TExpressionRangeType[TExpressionRangeType["INVALID"] = 0] = "INVALID";
    TExpressionRangeType[TExpressionRangeType["INTEGER"] = 1] = "INTEGER";
    TExpressionRangeType[TExpressionRangeType["FLOAT"] = 2] = "FLOAT";
    TExpressionRangeType[TExpressionRangeType["DOUBLE"] = 3] = "DOUBLE";
    return TExpressionRangeType;
})({});
