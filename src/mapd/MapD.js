...
MapD_sql_execute_df_args.prototype.write = function(output) {
  ...
  if (this.first_n !== null && this.first_n !== undefined) {
    output.writeFieldBegin('first_n', Thrift.Type.I32, 3);
    output.writeI32(this.first_n);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
...
MapDClient.prototype.sql_execute_df = function(session, query, first_n, callback) {
  this._seqid = this.new_seqid();
  this._reqs[this.seqid()] = callback;
  this.send_sql_execute_df(session, query, first_n);
};

MapDClient.prototype.send_sql_execute_df = function(session, query, first_n) {
  var output = new this.pClass(this.output);
...
MapDProcessor.prototype.process_sql_execute_df = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  this._handler.sql_execute_df(args.session, args.query, args.first_n, function (err, result) {
    var result_obj;
    if ((err === null || typeof err === 'undefined') || err instanceof ttypes.TMapDException) {
